...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // elevator1 = new CANSparkMax(12, MotorType.kBrushless);
    // // elevator1.setInverted(false);
    // elevator2 = new CANSparkMax(13, MotorType.kBrushless);
    // elevator2.follow(elevator1, true);
    shoot1 = new CANSparkMax(10, MotorType.kBrushless);
    // shoot1.setInverted(false);
    shoot2 = new CANSparkMax(11, MotorType.kBrushless);
    // shoot2.follow(shoot1, false);
    paddy = new CANSparkMax(9, MotorType.kBrushless);
    // paddy.setInverted(false);
    funnel = new CANSparkMax(7, MotorType.kBrushless);
