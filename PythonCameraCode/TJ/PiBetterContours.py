...
NetworkTables.initialize(server='10.25.64.212')
...
while(True):
    ...
    for contour in contours:
        ...
        xCentersTable.append(x)
        yCentersTable.append(y)
    ...
    table.putNumber('contours', len(contours))
    table.putNumberArray('x centers', xCentersTable)
    table.putNumberArray('y centers', yCentersTable)
